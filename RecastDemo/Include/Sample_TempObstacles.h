...
public:
	...
	void addTempCylinderObstacle(const float* pos, const float radius, const float height);
	void addTempBoxObstacle(const float* pos, const float width, const float height);
